...
class MambaBlock(ResidualBlock):
    ...
    def _build_core_layer(self) -> nn.Module:
        class MambaWrapper(nn.Module):
            ...
            def build_fresh_state(self, batch_size: int, max_seqlen: int, dtype: torch.dtype):  # Check layer_idx
                conv_state, ssm_state = self.mamba.allocate_inference_cache(batch_size, max_seqlen, dtype=dtype)
